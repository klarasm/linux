...
collapse_exceed_swap_pte
       The number of anonymous THP regions which contain at least one swap
...
collapse_exceed_none_pte
       The number of anonymous THP regions where the number of none PTEs
...
collapse_exceed_shared_pte
       The number of anonymous THP regions which contain at least one shared PTE.
       Currently khugepaged does not support collapsing mTHP regions that
       contain a shared PTE. This counter can be used to monitor the
       number of khugepaged mTHP collapses that failed due to the presence
       of a shared PTE.
