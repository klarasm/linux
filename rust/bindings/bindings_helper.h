...
const vm_flags_t RUST_CONST_HELPER_VM_GROWSDOWN = VM_GROWSDOWN;
const vm_flags_t RUST_CONST_HELPER_VM_UFFD_MISSING = VM_UFFD_MISSING;
const vm_flags_t RUST_CONST_HELPER_VM_PFNMAP = VM_PFNMAP;
const vm_flags_t RUST_CONST_HELPER_VM_UFFD_WP = VM_UFFD_WP;
const vm_flags_t RUST_CONST_HELPER_VM_LOCKED = VM_LOCKED;
const vm_flags_t RUST_CONST_HELPER_VM_IO = VM_IO;
const vm_flags_t RUST_CONST_HELPER_VM_SEQ_READ = VM_SEQ_READ;
const vm_flags_t RUST_CONST_HELPER_VM_RAND_READ = VM_RAND_READ;
